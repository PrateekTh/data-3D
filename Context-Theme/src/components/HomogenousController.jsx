...
function HomogenousController({dataset, setViewportData}) {
    ...
    if(dataset.index) return ( <>        
        <div className="flex-col space-y-4 text-lg p-4 text-left font-mono"> 
            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-2"> Homogenous Plot</div>
            <div className="text-2xl font-bold text-zinc-700 dark:text-zinc-400"> This plot type will be added soon!</div>
            <div className=' text-zinc-800 dark:text-white'>
                ...
                <ul>
                    ...
                    <li><b className='text-purple-600 dark:text-purple-400'>possible fields</b>: Different years, Regions, etc..</li>
